...
interface IPointHook {
    /**
     * @dev To calculate the amount of money can be deducted by points in this registration
    ...
    /**
     * @dev To deduct points againts a certain amount of money in this registration
     * @param _identifier The identifier of TLD
     * @param _name The name to be registered
     * @param _buyer The address to do the registration
     * @param _duration The duration of the registration
